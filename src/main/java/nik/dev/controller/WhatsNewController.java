...
public class WhatsNewController {
	...
	public List<WhatsNew> get(@RequestParam("start") @DateTimeFormat(pattern="dd.MM.yyyy'T'HH:mm:ss") Date start, 
			@RequestParam("end") @DateTimeFormat(pattern="dd.MM.yyyy'T'HH:mm:ss") Date end){
