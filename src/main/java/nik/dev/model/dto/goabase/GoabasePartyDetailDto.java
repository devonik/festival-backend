...
public class GoabasePartyDetailDto {
	private Long id;
	...
	private String textDeco;
	private String textLocation;
	private String textEntryFee;
	private String textMore;
	private String nameOrganizer;
	private String textOrganizer;
	private String urlOrganizer;
	...
	public void setTextDeco(String textDeco) {
	...
	public String getTextEntryFee() {
		return textEntryFee;
	}

	public void setTextEntryFee(String textEntryFee) {
		this.textEntryFee = textEntryFee;
	}
	...
	public String getTextOrganizer() {
		return textOrganizer;
	}

	public void setTextOrganizer(String textOrganizer) {
		this.textOrganizer = textOrganizer;
	}

	public String getUrlOrganizer() {
		return urlOrganizer;
	}

	public void setUrlOrganizer(String urlOrganizer) {
		this.urlOrganizer = urlOrganizer;
	}
	...
	public String getUrlImageFull() {
		return urlImageFull;
	}

	public void setUrlImageFull(String urlImageFull) {
	...
	public void setUrlParty(String urlParty) {
		this.urlParty = urlParty;
	}
